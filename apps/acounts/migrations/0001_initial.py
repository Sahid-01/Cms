    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Timestamp when the record was created', null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Timestamp when the record was last updated', null=True)),
                ('is_deleted', models.BooleanField(db_index=True, default=False, help_text='Indicates if this record has been soft deleted')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classes_assigned', models.TextField(blank=True, help_text='Comma separated class names')),
                ('subjects_teaching', models.TextField(blank=True, help_text='Comma separated subjects')),
